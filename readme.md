...
This is JBelt project! It's a deployable Maven 3 project to help you
...
This will deploy `target/jbelt-webapp.war`.
 
The application will be running at the following URL <http://localhost:8080/jbelt-webapp/>.
